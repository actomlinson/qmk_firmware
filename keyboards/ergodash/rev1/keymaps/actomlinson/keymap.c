...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |  `   |   Q  |   W  |   E  |   R  |   T  |   -  |                    |   =  |   Y  |   U  |   I  |   O  |   P  |  \   |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | Tab  |   A  |   S  |   D  |   F  |   G  | EISU |                    | Enter|   H  |   J  |   K  |   L  |   ;  |  "   |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  | Space| Home |      | End  | Space|   N  |   M  |   ,  |   .  |   /  | Shift|
   * |-------------+------+------+------+------+      +------+------+------+      +------+------+------+------+-------------|
   * | Ctrl |  GUI |  ALt | Ctrl |||||||| Enter| Space|  Del |||||||| Del  | Space| Bksp |||||||| Left | Down |  Up  | Right|
:   * ,----------------------------------------------------------------------------------------------------------------------. 
   */
  [_QWERTY] = LAYOUT( \
    ...
    KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    EISU ,                        KC_ENT, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_HOME ,                        KC_END , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
    KC_LCTL, KC_LGUI, KC_LALT, KC_LCTL,          KC_ENT,  KC_SPC ,  KC_DEL,         KC_DEL ,KC_SPC , KC_BSPC,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
